...
In this case, as `3` is the last part that is numeric, `1 2 3` are treated as indices and `college friend` is treated as `tagName`. +
...
_Figure 4.9.1a : Theme Command Typing Command Word Only_
...
_Figure 4.9.1c : Theme Command Typing Invalid Theme Word_
